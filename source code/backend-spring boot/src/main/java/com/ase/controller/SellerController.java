...
import com.ase.config.JwtProvider;
import com.ase.domain.AccountStatus;
...
import com.ase.repository.VerificationCodeRepository;
import com.ase.response.ApiResponse;
import com.ase.response.AuthResponse;
import com.ase.service.*;
import com.ase.service.impl.CustomeUserServiceImplementation;
import com.ase.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Trade Hub Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Trade Hub Email Verification Code";
        String text = "Welcome to Trade Hub, verify your account using this link ";
