/* checksum : da2c34fb6660e3615aa942553df73f47 */
@cds.external : true
...
entity API_BUSINESS_PARTNER.A_BPContactPersonEmlAddr {
  @sap.display.format : 'UpperCase'
...
entity API_BUSINESS_PARTNER.A_BPContactPersonFaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity API_BUSINESS_PARTNER.A_BPContactPersonMblNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity API_BUSINESS_PARTNER.A_BPContactPersonTelNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity API_BUSINESS_PARTNER.A_BPContactPersonWbsteURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity API_BUSINESS_PARTNER.A_BPContactToAddress {
  ...
  to_BPRelshpCntctPersnEmailAddr : Association to many API_BUSINESS_PARTNER.A_BPContactPersonEmlAddr {  };
  to_BPRelshpCntctPersnFaxNumber : Association to many API_BUSINESS_PARTNER.A_BPContactPersonFaxNmbr {  };
  to_BPRelshpCntctPersnMblNumber : Association to many API_BUSINESS_PARTNER.A_BPContactPersonMblNmbr {  };
  to_BPRelshpCntctPersnTelNumber : Association to many API_BUSINESS_PARTNER.A_BPContactPersonTelNmbr {  };
  to_BPRelshpCntctPersnWbsteURL : Association to many API_BUSINESS_PARTNER.A_BPContactPersonWbsteURL {  };
